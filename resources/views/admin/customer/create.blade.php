				...
				<form id="formcustomer" class="form-horizontal form-bordered form-label-stripped">
					<div class="form-body ">
						...
						<div class="form-group">
							...
							<div class="col-md-10">
                                <textarea rows="8" class="form-control" id="address"  name="address"></textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-2 control-label">Phone Number <span class="required">*</span></label>
							<div class="col-md-10">
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-8 col-md-4">
								...
								<button class="btn btn-sm  green-haze btn-circle"  type="button" id="savecustomer"><i class="fa fa-spinner fa-spin spiner loading-save" style="display:none"></i> <i class="fa fa-check"></i> Save</button>
							</div>
						</div>
					</div>
				</form>
